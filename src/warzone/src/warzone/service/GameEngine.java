 ...
 * Main game loop.
 * 
 * Loop over each player for the assign reinforcements, issue orders, and
 * execute orders main game loop phases
 * 
 */
public class GameEngine {
	...
	/**
	 * This method is the entrance of the game. It will initiate the game context
	 * and use
	 ...
	 *         1. there is just one player left 2. the number of game turn is
	 *         greater than 100.
	 */
	...
	/**
	 * This method will assign each player the correct number of reinforcement
	 * armies
	...
	/**
	 * The GameEngine class calls the issue_order() method of the Player. This
	 * method will wait for the following command,
	 * then create a deploy order object on the players list of orders, then reduce
	 * the number of armies in the
	 * players reinforcement pool. The game engine does this for all players in
	 * round-robin fashion until all the players
	...
	/**
	 * The GameEngine calls the next_order() method of the Player. Then the Order
